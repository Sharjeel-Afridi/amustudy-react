...
const Create = () => {
  ...
  return (
    // <div className="flex justify-center items-center w-screen h-screen bg-black/30 z-10">
      <div id="form" className='w-full bg-background-light p-3 text-primary-text font-medium shadow rounded-md' onClick={(e) => e.stopPropagation()}>
        <div className="flex flex-col items-center justify-start gap-4 mb-4">
          <input
            type="text"
            className='w-full border-[1px] border-white/10 rounded-md p-2 bg-background-light focus:outline-none'
            placeholder="Title"
            value={title}
            rows='2'
          ...
          <textarea
            type="text"
            className='w-full border-[1px] border-white/10 rounded-md resize-y ml-0 p-2 bg-background-light focus:outline-none'
          ...
          />
          {/* <select
            className="w-full border-[1px] border-white/10 rounded-md p-2 bg-background-light focus:outline-none mt-2"
